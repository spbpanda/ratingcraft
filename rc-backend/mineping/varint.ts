...
const varint = {
	 ...
	 * @returns {Buffer}
	 */
	encodeString: (val: WithImplicitCoercion<string> | { [Symbol.toPrimitive](hint: "string"): string; }) => {
	 ...
	 * @returns {number}
	 */
	decodeInt: (buffer: { readUInt8: (arg0: number) => any; }, offset: number) => {
