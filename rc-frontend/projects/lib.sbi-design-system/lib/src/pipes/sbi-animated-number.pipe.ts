...
/**
 * @deprecated - предпочтительнее использовать sbiSoloAnimatedNumber (SbiSoloAnimatedNumberPipe)
 * Пайп для анимированного отображения изменения числовых значений (принимает 2 числовых параметра - начало и окончание).
 *
